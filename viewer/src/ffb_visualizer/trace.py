...
def _event_payload(event: Frame, origin: int, frequency: int) -> dict[str, object]:
    return {
        ...
        "sample_period": event.sample_period,
        "gain": event.gain,
        "start_delay": event.start_delay,
        "trigger_button": event.trigger_button,
        "trigger_repeat": event.trigger_repeat,
        "iterations": event.iterations,
        "envelope_attack_level": event.envelope_attack_level,
        "envelope_attack_time": event.envelope_attack_time,
        "envelope_fade_level": event.envelope_fade_level,
        "envelope_fade_time": event.envelope_fade_time,
